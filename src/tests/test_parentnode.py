...
class TestParentNode(unittest.TestCase):
    def test_to_html(self):
        ...
        expectedHTML = "<p><b>Bold text</b>Normal text<i>italic text</i>Normal text</p>"
    ...
    def test_nested_nodes(self):
        ...
        expectedHTML = "<div><p><b>Bold Text</b>Normal Text</p><i>italic text</i></div>"
    ...
    def test_parent_node_with_attributes(self):
        node = ParentNode("div", [LeafNode("span", "Some text")], {"class": "container", "id": "main"})
        expectedHTML = '<div class="container" id="main"><span>Some text</span></div>'
        self.assertEqual(node.to_html(), expectedHTML)
